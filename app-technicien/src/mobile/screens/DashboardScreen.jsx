    ...
    <Screen withBottomNav>
      ...
      <main className="px-margin-mobile pt-24 pb-8">
        <section className="mb-lg">
          <h2 className="font-headline-lg-mobile text-headline-lg-mobile text-on-surface">Welcome back, {user.prenom || 'J. Miller'}</h2>
        ...
        <div className="grid grid-cols-1 gap-gutter mb-lg">
          ...
          <div className="bg-error-container p-md rounded-xl shadow-lg border-l-4 border-error flex flex-col justify-between h-40 relative overflow-hidden">
            ...
            <div className="flex justify-between items-start gap-3">
              ...
              <button onClick={() => critical && openPanne(critical)} className="bg-error text-on-error font-label-md px-4 py-2 rounded-lg active:scale-95 transition-all shadow-lg border-2 border-on-error/20 shrink-0">Intervene</button>
            </div>
          </div>
        </div>
        ...
        <section className="space-y-md">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => navigate('intervention')} className="text-primary font-label-md hover:underline">View All</button>
          </div>
          <div className="flex gap-2 mb-2 overflow-x-auto">
            <button className="bg-primary text-on-primary px-4 py-1 rounded-full text-label-sm shrink-0">All</button>
        ...
        <section className="space-y-md mt-lg">
          ...
          <button onClick={() => navigate('report')} className="w-full py-4 bg-primary text-on-primary rounded-xl font-headline-md text-label-md font-bold shadow-lg shadow-primary/20 active:scale-95">Report a Breakdown</button>
        </section>
      </main>
